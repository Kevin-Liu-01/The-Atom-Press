...
function Navbar(props) {
  ...
  return (
    <div className="pb-[5.25rem] md:pb-0">
      <div className="fixed z-50 w-full bg-default md:relative  py-4 border-b-[3px] border-bordermaroon mx-auto max-w-[100rem] mb-8">
        <div className="flex md:grid md:grid-cols-3 md:mx-0 justify-items-stretch px-8">
          {/*tab logo */}
          <button
