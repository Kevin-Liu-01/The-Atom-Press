    ...
    <div className="py-4 border-b-4 border-bordermaroon px-8 mx-auto max-w-[100rem] mb-8">
      <div className="grid grid-cols-3 md:mx-0 ">
        ...
        <svg
          ...
          className="h-[35px] md:h-10 my-auto w-auto hover:scale-105 transition duration-200 ease-in-out"
        >
          <path
        ...
        <div className="flex justify-center ">
          <a href="/">
            <img
              src="/Atom_Logo.png"
              className=" flex my-auto h-20  hover:scale-105 transition duration-200 ease-in-out"
            ></img>
          </a>
        </div>
      </div>
